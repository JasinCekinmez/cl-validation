...
ArmsLengthFipsData=LollipopCreator("PRIMARY CATEGORY CODE",1,103,"","A","",FALSE,FALSE,FALSE)
#print(ArmsLengthData)
#write.csv(ArmsLengthData,"~/cl-validation/Output/ArmsLengthData.csv")
write.csv(ArmsLengthFipsData,"~/cl-validation/Output/ArmsLengthFipsData.csv")
#disconnects in order to avoid garbage collecting 
dbDisconnect(con)
````
...
PlotMaker(FALSE,"LAND USE CODE - STATIC",TRUE)
PlotMaker(FALSE,"LAND USE CODE - STATIC",FALSE)
````
...
fullData = tbl(con, "deeds")
pr=fullData |> filter(`DEED SITUS STATE - STATIC`=="WY") |> filter(`FIPS CODE`==48007)
