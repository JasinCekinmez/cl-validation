...
print(tibbleCreator("SALE RECORDED DOCUMENT NUMBER","DEED SITUS STATE - STATIC",FALSE,FALSE))
...
PlotMaker=function(fips,column,binary){
...
PlotMaker(TRUE,"SALE RECORDED DOCUMENT NUMBER",TRUE)
````
